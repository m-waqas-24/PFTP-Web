...
import Datas from '../data/apply/how-to-apply.json';
import { Container, Row, Col } from 'react-bootstrap';
import ModalVideo from 'react-modal-video';
import { Styles } from "./styles/howToApply";

class ApplyVideo extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
                                    ...
                                    <Col md="12">
                                        <div className="hero-box text-center">
                                            ...
                                            <div className="video-player">
                                                <ModalVideo channel='youtube' isOpen={this.state.isOpen} videoId='sd4EcU-Jr6s' onClose={() => this.setState({ isOpen: false })} />
