    ...
    return (
        <Styles>
            ...
            <div className="main-wrapper contact-page">
                ...
                {/* Breadcroumb */}
                <BreadcrumbBox title="Contact Us" bg="Breadcrumbs/infoDesk/Contact-us.png" />
                            ...
                            <Col md="4">
                                ...
                                <div className="contact-icon-box d-flex">
                                    ...
                                    <div className="box-content">
                                        <h5>Our Location</h5>
                                        <p>Head-Office 57400 Postal Area, Model Town, Lahore, Punjab</p>
                                    </div>
                                </div>
                                <div className="contact-icon-box d-flex">
                                    <div className="icon">
                                    ...
                                    <div className="box-content">
                                        <h5>Email Address</h5>
                                        <p><a href='mailto:support@pftpedu.org'>support@pftpedu.org</a></p>
                                    </div>
                                </div>
                                <div className="contact-icon-box d-flex">
                                    <div className="icon">
                                    ...
                                    <div className="box-content">
                                        <h5>Phone Number</h5>
                                        <p><a href="tel:+923034321118"> +92 (303)-4321118</a> <br/> <a href="tel:+923231230488">+92 (318)-4321118 </a></p>
                                    </div>
                                </div>
