                            ...
                            <Col lg="9" md="8" sm="12">
                                <div className="course-details-top">
                                    ...
                                    <div className="course-details-banner">
                                        <img src={course.detail ? global.config.URL.img.public + course.detail.img : ''} alt="" className="img-fluid" />
                                    </div>
                                    ...
                                    <Row>
                                        <Col md="12">
                                            <div className="course-details-feature">
                                                ...
                                                <button type="button" onClick={() => enroll()} className="enroll-btn">Enroll Course</button>
                                            </div>
                                        </Col>
                                        <Col md="12">
                                            {course.siblings ? <PopularCourse courses={course.siblings} />:''}                                           
                                        </Col>
                                        <Col md="12">
                                            <CourseTag />
                                        </Col>
