                            ...
                            courses.map((course, i) => (
                                <div className="item-box d-flex" key={i}>
                                    <div className="item-img">
                                        <a onClick={() => {window.location.href=`${process.env.PUBLIC_URL + course.slug}`}} href="#!" ><img src={course.course_detail ? global.config.URL.img.public + course.course_detail.img : ''} alt="" /></a>
                                    </div>
